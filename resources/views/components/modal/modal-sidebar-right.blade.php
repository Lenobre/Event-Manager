<div
    {{ $attributes->merge(['class' => 'bg-gray-50 dark:bg-zinc-800 fixed top-0 right-0 h-full w-full max-w-sm z-50 animate-fade-left animate-duration-500 overflow-hidden rounded-l-xl']) }}>
